  ...
  <div className="p-3 lg: ">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Sarcastify.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Sarcastify, accessible from{" "}
          <a
            href="https://sarcastify.co"
    ...
    <ul>
      <li>
        ...
        <a
          href="https://sarcastify.co/privacy"
          rel="external nofollow noopener"
          target="_blank"
        >
          https://sarcastify.co/privacy
        </a>
      </li>
    </ul>
  </div>
